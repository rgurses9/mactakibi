...
import { MatchDetails, AnalysisResult, BotConfig } from './types';
...
const App: React.FC = () => {
    ...
    const handleBotConfigSave = (newConfig: BotConfig) => {
                ...
                <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="font-bold text-gray-900 text-sm leading-tight hidden sm:block">
                            Maç Takip Sistemi <span className="text-[10px] text-blue-500 ml-1">v11.3</span>
                        </h1>
                    </div>
