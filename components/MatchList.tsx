          ...
          return (
            ...
            >
              <div className="flex flex-col md:flex-row">
                ...
                `}>
                    <div className={`text-2xl font-black tracking-tight ${isGreenMode ? 'text-green-800' : 'text-gray-600'}`}>
                        {match.time}
                    </div>
                ...
                <div className="flex-1 p-5">
                    ...
                    <div className="flex items-center gap-3 mb-6">
                        <span className={`text-lg font-bold flex-1 text-right ${isGreenMode ? 'text-gray-900' : 'text-gray-600'}`}>{match.teamA}</span>
                        <div className="bg-gray-100 text-gray-400 text-[10px] font-black px-2 py-1 rounded">VS</div>
                        <span className={`text-lg font-bold flex-1 text-left ${isGreenMode ? 'text-gray-900' : 'text-gray-600'}`}>{match.teamB}</span>
                    </div>
